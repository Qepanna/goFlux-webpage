...
-   [**Los Gatos Research (LGR)**](import.qmd#sec-LGR-loop): ultra-portable GGA (GLA132 series), micro ultra-portable GGA (GLA131 series), N2OM1 (GLA151 series) and N2Oi2 (GLA451 series)
...
| `gas` | character vector; a pattern to match the columns containing each gas measurement. Choose from: "CO2_ppm", "CH4_ppm", "N2O_ppm", "NH3_ppm", "NO2_ppm", "NO_ppm" and "H2O_ppm". Used with `instrument = "GasmetPD"` only. |
...
The argument `gas` is used with the function [`import.GasmetPD`](#sec-GasmetPD-single) only.
