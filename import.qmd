...
| `instrument`                                                            | character string; specifies which instrument was used to generate the files contained in the folder path. Choose one of the following: "DX4015", "EGM5", "G2508", "G4301" "GAIA", "GasmetPD", "GT5000", "LI-6400", "LI-7810", "LI-7820", "LI-8100", "LI-8200", "UGGA", "uCH4", "uN2O" or "N2OM1". For more information about an instrument, see the section "See Also" below. |
...
The arguments `active`, `pivot`, `flag`, `background`, `CH.col`, `PAR.col`, `Tcham.col`, `Tsoil.col`, `SWC.col`, `Op.stat.col`, `inst1`, `inst2`, `inst3`, `gas1`, `gas2`, `gas3`, `prec1`, `prec2`, `prec3`, `dry1`, `dry2`, `dry3`, `sep` and `skip` are used in the function `import.GAIA` only.
...
Note that with this instrument, `keep_all` is not a valid argument. However, several other arguments can be used: `active`, `pivot`, `flag`, `background`, etc. Look up the [GAIA2TECH ECOFlux](#0) instrument under the "Single file import" section for more details.
