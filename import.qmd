...
The arguments `active`, `pivot`, `flag`, `backgroun`, `CH.col`, `PAR.col`, `Tcham.col`, `Tsoil.col`, `SWC.col`, `Op.stat.col`, `CO2.col`, `CH4.col`, `H2O1.col`, `N2O.col`, `H2O2.col`, are used in the function [`import.GAIA`](#sec-GAIA-single) only.
