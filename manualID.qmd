...
::: callout-tip
After the identification of measurements, one may which to add a deadband across all measurements, crop the start or end of measurements, or apply specific modifications per measurement. To do so, look up the function [`crop.meas`](other.qmd#crop.meas).
:::
