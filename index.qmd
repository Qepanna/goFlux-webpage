...
The package is ready to use and fully functional, but errors may still occur. Please report any issues directly to the maintainer, Karelle Rheault ([karh\@ign.ku.dk](mailto:karh@ign.ku.dk){.email}), including script and raw data if necessary, or [open an issue on GitHub](https://github.com/Qepanna/goFlux/issues). Thank you for helping me in the development of this tool! 🙏
:::
