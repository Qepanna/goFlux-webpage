...
The package is ready to use and fully functional, but errors may still occur. Please report any issues to the maintainer, Karelle Rheault ([karh\@ign.ku.dk](mailto:karh@ign.ku.dk){.email}), including script and raw data if necessary. Thank you for helping me in the development of this tool! 🙏
:::
...
3.  [Identify measurements](manualID.qmd)
